    ...
    <div class="wrapper">
        ...
        <form action="registerprocess.php" method="post">
            <div class="form-group">
                <label>ID</label>
                <input type="text" id="fid" name="fid" size="20" placeholder="Enter user ID" required>
            ...
            <div class="form-group">
                <label>IC</label>
                <input type="text" size="20" name="fic" id="fic" placeholder="Enter IC number" required>
